...
public class TradeHistoryService {
    ...
    public ApiResponse edit(UUID id, TradeHistoryDto tradeHistoryDto) {
    ...
    public ApiResponse deleteAllByTradeId(UUID trade_id) {
        tradeHistoryRepository.deleteAllByTrade_Id(trade_id);
        return new ApiResponse("DELETED" , true);
    }

    public ApiResponse getAllByTradeId(UUID trade_id) {
    ...
    public ApiResponse deleteByTradeId(UUID trade_id) {
        tradeHistoryRepository.deleteByTrade_Id(trade_id);
        return new ApiResponse("DELETED",true);
    }

    public ApiResponse getByTradeId(UUID trade_id) {
    ...
    public ApiResponse getAllByBranch(UUID branch_id) {
